...
<body>
    ...
    <main>
        ...
        <div class="electricCar product-box">
            <div class="product_top">
                ...
                <nav aria-label="breadcrumb">
                   <ol class="breadcrumb container d-flex justify-content-end">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">電動車</li>
                   </ol>
               </nav>
            ...
            <div class="electricCar_content product-box_content">
                ...
                <div class="component component-3" data-target="#component-pic-2">
                    <div class="component_inner">
                        <img class="component_icon_dash" src="./public/img/icon-dashCircle.svg" alt="">
                        <img class="component_icon" src="./public/img/icon-plus_1.svg" alt="">
                    </div>
                </div>
                <div class="component component-4" data-target="#component-pic-1">
                    <div class="component_inner">
                        <img class="component_icon_dash" src="./public/img/icon-dashCircle.svg" alt="">
                        <img class="component_icon" src="./public/img/icon-plus_1.svg" alt="">
                    </div>
                </div>
                <div class="component component-5" data-target="#component-pic-2">
                    <div class="component_inner">
                        <img class="component_icon_dash" src="./public/img/icon-dashCircle.svg" alt="">
                        <img class="component_icon" src="./public/img/icon-plus_1.svg" alt="">
                    </div>
                </div>
                <img class="component-pic component-pic-1" id="component-pic-1" src="./public/img/electricCar-1.png">
                <img class="component-pic component-pic-2" id="component-pic-2" src="./public/img/electricCar-2.png">
            </div>           
        </div>
        ...
        <div class="product-componentList">
            <nav class="product-componentList_tab">
                <div class="nav nav-tabs container" id="nav-tab" role="tablist">
                  <button class="nav-link active" id="gear-tab" data-bs-toggle="tab" data-bs-target="#gear" type="button" role="tab" aria-controls="gear" aria-selected="true">減速箱齒輪組</button>
                  ...
                  <button class="nav-link" id="axis-tab" data-bs-toggle="tab" data-bs-target="#axis" type="button" role="tab" aria-controls="axis" aria-selected="false">電機軸/馬達軸</button>
                </div>
            </nav>
